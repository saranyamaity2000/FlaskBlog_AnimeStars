...
@users.route("/register", methods=['GET', 'POST'])  # Get request and POST request
def register():
...
def user_post(username):
    ...
    # breaking into multiple lines by \ in the above section !
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your Password has been Updated! You will be able to log in', 'success')  # we have used f string for ease
        return redirect(url_for('users.login'))
